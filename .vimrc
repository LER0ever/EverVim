...
" Plugins {
    ...
    " OmniComplete {
        ...
        if !exists('g:evervim_no_omni_complete')
            ...
            if exists('g:evervim_map_cr_omni_complete')
    ...
    " To disable omni complete, add the following to your .vimrc.before.local file:
    "   let g:evervim_no_omni_complete = 1
        elseif !exists('g:evervim_no_omni_complete')
            " Enable omni-completion.
            autocmd FileType css setlocal omnifunc=csscomplete#CompleteCSS
            autocmd FileType html,markdown setlocal omnifunc=htmlcomplete#CompleteTags
            autocmd FileType javascript setlocal omnifunc=javascriptcomplete#CompleteJS
    ...
    if has('gui_running')
        ...
        if !exists("g:evervim_no_big_font")
            if LINUX() && has("gui_running")
                set guifont=Knack\ Nerd\ Font\ Regular\ 12,Noto\ Mono\ Regular\ 12,Menlo\ Regular\ 11,Consolas\ Regular\ 12,Courier\ New\ Regular\ 14
